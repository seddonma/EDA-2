...
## Creates a graph and save it as png file titled "plot2.png"
png("plot2.png", width = 480, height = 480)
plot(tot_em_BC$year, tot_em_BC$total_emissions, pch = 19, bg = "black", main = "Total emissions in the US for the years 1999, 2002, 2005, and 2008", xlab = "Year", ylab = "Total Emissions (PM2.5)")
